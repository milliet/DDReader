/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/xpcom/ds/nsIVariant.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIVariant : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetAsJSVal(JS::Value *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIVARIANT \
  ...
  NS_IMETHOD GetAsJSVal(JS::Value *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIVARIANT(_to) \
  ...
  NS_IMETHOD GetAsJSVal(JS::Value *_retval NS_OUTPARAM) { return _to GetAsJSVal(_retval); } \
...
#define NS_FORWARD_SAFE_NSIVARIANT(_to) \
  ...
  NS_IMETHOD GetAsJSVal(JS::Value *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAsJSVal(_retval); } \
...
/* [noscript] jsval getAsJSVal (); */
NS_IMETHODIMP nsVariant::GetAsJSVal(JS::Value *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
