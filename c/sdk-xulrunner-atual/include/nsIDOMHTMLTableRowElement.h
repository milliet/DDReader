/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/interfaces/html/nsIDOMHTMLTableRowElement.idl
 */
...
#define NS_IDOMHTMLTABLEROWELEMENT_IID_STR "637b44fe-229c-4a72-a9e9-ccdb265821ed"

#define NS_IDOMHTMLTABLEROWELEMENT_IID \
  {0x637b44fe, 0x229c, 0x4a72, \
    { 0xa9, 0xe9, 0xcc, 0xdb, 0x26, 0x58, 0x21, 0xed }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMHTMLTableRowElement : public nsIDOMHTMLElement {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD InsertCell(PRInt32 index, nsIDOMHTMLElement * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOMHTMLTABLEROWELEMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD InsertCell(PRInt32 index, nsIDOMHTMLElement * *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIDOMHTMLTABLEROWELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD InsertCell(PRInt32 index, nsIDOMHTMLElement * *_retval NS_OUTPARAM) { return _to InsertCell(index, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMHTMLTABLEROWELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD InsertCell(PRInt32 index, nsIDOMHTMLElement * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->InsertCell(index, _retval); } \
...
/* nsIDOMHTMLElement insertCell (in long index) raises (DOMException); */
NS_IMETHODIMP nsDOMHTMLTableRowElement::InsertCell(PRInt32 index, nsIDOMHTMLElement * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
