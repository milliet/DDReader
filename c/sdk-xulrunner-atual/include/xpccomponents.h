/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/js/src/xpconnect/idl/xpccomponents.idl
 */
...
#define NS_IXPCCOMPONENTS_UTILS_IID_STR "fed2d752-6cb3-4135-97b0-2c290e541e2d"

#define NS_IXPCCOMPONENTS_UTILS_IID \
  {0xfed2d752, 0x6cb3, 0x4135, \
    { 0x97, 0xb0, 0x2c, 0x29, 0x0e, 0x54, 0x1e, 0x2d }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIXPCComponents_Utils : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetGlobalForObject(void) = 0;
...
#define NS_DECL_NSIXPCCOMPONENTS_UTILS \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetGlobalForObject(void); \
...
#define NS_FORWARD_NSIXPCCOMPONENTS_UTILS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetGlobalForObject(void) { return _to GetGlobalForObject(); } \
...
#define NS_FORWARD_SAFE_NSIXPCCOMPONENTS_UTILS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetGlobalForObject(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetGlobalForObject(); } \
...
/* void getGlobalForObject (); */
NS_IMETHODIMP nsXPCComponents_Utils::GetGlobalForObject()
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
