/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/toolkit/mozapps/extensions/amIWebInstaller.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE amIWebInstaller : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD InstallAddonsFromWebpage(const nsAString & aMimetype, nsIDOMWindow *aWindow, nsIURI *aReferer, const PRUnichar * *aUris, const PRUnichar * *aHashes, const PRUnichar * *aNames, const PRUnichar * *aIcons, amIInstallCallback *aCallback, PRUint32 aInstallCount, PRBool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_AMIWEBINSTALLER \
  ...
  NS_SCRIPTABLE NS_IMETHOD InstallAddonsFromWebpage(const nsAString & aMimetype, nsIDOMWindow *aWindow, nsIURI *aReferer, const PRUnichar * *aUris, const PRUnichar * *aHashes, const PRUnichar * *aNames, const PRUnichar * *aIcons, amIInstallCallback *aCallback, PRUint32 aInstallCount, PRBool *_retval NS_OUTPARAM); 
...
/* boolean installAddonsFromWebpage (in AString aMimetype, in nsIDOMWindow aWindow, in nsIURI aReferer, [array, size_is (aInstallCount)] in wstring aUris, [array, size_is (aInstallCount)] in wstring aHashes, [array, size_is (aInstallCount)] in wstring aNames, [array, size_is (aInstallCount)] in wstring aIcons, [optional] in amIInstallCallback aCallback, [optional] in PRUint32 aInstallCount); */
NS_IMETHODIMP amWebInstaller::InstallAddonsFromWebpage(const nsAString & aMimetype, nsIDOMWindow *aWindow, nsIURI *aReferer, const PRUnichar * *aUris, const PRUnichar * *aHashes, const PRUnichar * *aNames, const PRUnichar * *aIcons, amIInstallCallback *aCallback, PRUint32 aInstallCount, PRBool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
