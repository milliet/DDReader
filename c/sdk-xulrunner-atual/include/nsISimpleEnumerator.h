/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/xpcom/ds/nsISimpleEnumerator.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISimpleEnumerator : public nsISupports {
 public: 
  ...
  /* nsISupports getNext (); */
  NS_SCRIPTABLE NS_IMETHOD GetNext(nsISupports * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSISIMPLEENUMERATOR \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNext(nsISupports * *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSISIMPLEENUMERATOR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNext(nsISupports * *_retval NS_OUTPARAM) { return _to GetNext(_retval); } 
...
#define NS_FORWARD_SAFE_NSISIMPLEENUMERATOR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNext(nsISupports * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNext(_retval); } 
