/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/docshell/base/nsIDocShellTreeOwner.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDocShellTreeOwner : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTargetableShellCount(PRUint32 *aTargetableShellCount) = 0;
...
#define NS_DECL_NSIDOCSHELLTREEOWNER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTargetableShellCount(PRUint32 *aTargetableShellCount); 
...
#define NS_FORWARD_NSIDOCSHELLTREEOWNER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTargetableShellCount(PRUint32 *aTargetableShellCount) { return _to GetTargetableShellCount(aTargetableShellCount); } 
...
#define NS_FORWARD_SAFE_NSIDOCSHELLTREEOWNER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTargetableShellCount(PRUint32 *aTargetableShellCount) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTargetableShellCount(aTargetableShellCount); } 
...
/* readonly attribute unsigned long targetableShellCount; */
NS_IMETHODIMP nsDocShellTreeOwner::GetTargetableShellCount(PRUint32 *aTargetableShellCount)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
