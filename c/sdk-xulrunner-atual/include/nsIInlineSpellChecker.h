/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/editor/txtsvc/public/nsIInlineSpellChecker.idl
 */
...
#define NS_IINLINESPELLCHECKER_IID_STR "f456dda1-965d-470c-8c55-e51b38e45212"

#define NS_IINLINESPELLCHECKER_IID \
  {0xf456dda1, 0x965d, 0x470c, \
    { 0x8c, 0x55, 0xe5, 0x1b, 0x38, 0xe4, 0x52, 0x12 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIInlineSpellChecker : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMisspelledWord(nsIDOMNode *aNode, PRInt32 aOffset, nsIDOMRange * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIINLINESPELLCHECKER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMisspelledWord(nsIDOMNode *aNode, PRInt32 aOffset, nsIDOMRange * *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIINLINESPELLCHECKER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMisspelledWord(nsIDOMNode *aNode, PRInt32 aOffset, nsIDOMRange * *_retval NS_OUTPARAM) { return _to GetMisspelledWord(aNode, aOffset, _retval); } \
...
#define NS_FORWARD_SAFE_NSIINLINESPELLCHECKER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMisspelledWord(nsIDOMNode *aNode, PRInt32 aOffset, nsIDOMRange * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMisspelledWord(aNode, aOffset, _retval); } \
...
/* nsIDOMRange getMisspelledWord (in nsIDOMNode aNode, in long aOffset); */
NS_IMETHODIMP nsInlineSpellChecker::GetMisspelledWord(nsIDOMNode *aNode, PRInt32 aOffset, nsIDOMRange * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
