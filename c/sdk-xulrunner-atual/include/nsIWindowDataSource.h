/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/xpfe/components/windowds/nsIWindowDataSource.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIWindowDataSource : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetWindowForResource(const char * inResource, nsIDOMWindow * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIWINDOWDATASOURCE \
  NS_SCRIPTABLE NS_IMETHOD GetWindowForResource(const char * inResource, nsIDOMWindow * *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIWINDOWDATASOURCE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetWindowForResource(const char * inResource, nsIDOMWindow * *_retval NS_OUTPARAM) { return _to GetWindowForResource(inResource, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIWINDOWDATASOURCE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetWindowForResource(const char * inResource, nsIDOMWindow * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetWindowForResource(inResource, _retval); } 
...
/* nsIDOMWindow getWindowForResource (in string inResource); */
NS_IMETHODIMP nsWindowDataSource::GetWindowForResource(const char * inResource, nsIDOMWindow * *_retval NS_OUTPARAM)
{
