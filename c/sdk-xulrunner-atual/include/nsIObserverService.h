/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/xpcom/ds/nsIObserverService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIObserverService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD EnumerateObservers(const char * aTopic, nsISimpleEnumerator * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIOBSERVERSERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD EnumerateObservers(const char * aTopic, nsISimpleEnumerator * *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIOBSERVERSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD EnumerateObservers(const char * aTopic, nsISimpleEnumerator * *_retval NS_OUTPARAM) { return _to EnumerateObservers(aTopic, _retval); } 
...
#define NS_FORWARD_SAFE_NSIOBSERVERSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD EnumerateObservers(const char * aTopic, nsISimpleEnumerator * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->EnumerateObservers(aTopic, _retval); } 
...
/* nsISimpleEnumerator enumerateObservers (in string aTopic); */
NS_IMETHODIMP nsObserverService::EnumerateObservers(const char * aTopic, nsISimpleEnumerator * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
