...
#define NS_IDOMHTMLFORMELEMENT_IID_STR "7b859d90-6b01-4208-8922-7999653c7491"

#define NS_IDOMHTMLFORMELEMENT_IID \
  {0x7b859d90, 0x6b01, 0x4208, \
    { 0x89, 0x22, 0x79, 0x99, 0x65, 0x3c, 0x74, 0x91 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMHTMLFormElement : public nsIDOMHTMLElement {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNoValidate(PRBool *aNoValidate) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetNoValidate(PRBool aNoValidate) = 0;
...
#define NS_DECL_NSIDOMHTMLFORMELEMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNoValidate(PRBool *aNoValidate); \
  NS_SCRIPTABLE NS_IMETHOD SetNoValidate(PRBool aNoValidate); \
...
#define NS_FORWARD_NSIDOMHTMLFORMELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNoValidate(PRBool *aNoValidate) { return _to GetNoValidate(aNoValidate); } \
  NS_SCRIPTABLE NS_IMETHOD SetNoValidate(PRBool aNoValidate) { return _to SetNoValidate(aNoValidate); } \
...
#define NS_FORWARD_SAFE_NSIDOMHTMLFORMELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetNoValidate(PRBool *aNoValidate) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNoValidate(aNoValidate); } \
  NS_SCRIPTABLE NS_IMETHOD SetNoValidate(PRBool aNoValidate) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetNoValidate(aNoValidate); } \
...
/* attribute boolean noValidate; */
NS_IMETHODIMP nsDOMHTMLFormElement::GetNoValidate(PRBool *aNoValidate)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMHTMLFormElement::SetNoValidate(PRBool aNoValidate)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean checkValidity (); */
NS_IMETHODIMP nsDOMHTMLFormElement::CheckValidity(PRBool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
