/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/profile/public/nsIProfile.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIProfile : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ProfileExists(const PRUnichar * profileName, PRBool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIPROFILE \
  ...
  NS_SCRIPTABLE NS_IMETHOD ProfileExists(const PRUnichar * profileName, PRBool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIPROFILE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ProfileExists(const PRUnichar * profileName, PRBool *_retval NS_OUTPARAM) { return _to ProfileExists(profileName, _retval); } \
...
#define NS_FORWARD_SAFE_NSIPROFILE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ProfileExists(const PRUnichar * profileName, PRBool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ProfileExists(profileName, _retval); } \
...
/* boolean profileExists (in wstring profileName); */
NS_IMETHODIMP nsProfile::ProfileExists(const PRUnichar * profileName, PRBool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
