...
#define NS_IDOMCSS2PROPERTIES_IID_STR "79b66107-f9d2-42ac-bc68-b558d79037ec"

#define NS_IDOMCSS2PROPERTIES_IID \
  {0x79b66107, 0xf9d2, 0x42ac, \
    { 0xbc, 0x68, 0xb5, 0x58, 0xd7, 0x90, 0x37, 0xec }}
...
/* attribute DOMString MozOpacity; */
NS_IMETHODIMP nsDOMCSS2Properties::GetMozOpacity(nsAString & aMozOpacity)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMCSS2Properties::SetMozOpacity(const nsAString & aMozOpacity)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* attribute DOMString MozOutline; */
NS_IMETHODIMP nsDOMCSS2Properties::GetMozOutline(nsAString & aMozOutline)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMCSS2Properties::SetMozOutline(const nsAString & aMozOutline)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* attribute DOMString MozOutlineColor; */
NS_IMETHODIMP nsDOMCSS2Properties::GetMozOutlineColor(nsAString & aMozOutlineColor)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMCSS2Properties::SetMozOutlineColor(const nsAString & aMozOutlineColor)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* attribute DOMString MozOutlineStyle; */
NS_IMETHODIMP nsDOMCSS2Properties::GetMozOutlineStyle(nsAString & aMozOutlineStyle)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMCSS2Properties::SetMozOutlineStyle(const nsAString & aMozOutlineStyle)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* attribute DOMString MozOutlineWidth; */
NS_IMETHODIMP nsDOMCSS2Properties::GetMozOutlineWidth(nsAString & aMozOutlineWidth)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMCSS2Properties::SetMozOutlineWidth(const nsAString & aMozOutlineWidth)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* attribute DOMString MozOutlineOffset; */
NS_IMETHODIMP nsDOMCSS2Properties::GetMozOutlineOffset(nsAString & aMozOutlineOffset)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDOMCSS2Properties::SetMozOutlineOffset(const nsAString & aMozOutlineOffset)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
