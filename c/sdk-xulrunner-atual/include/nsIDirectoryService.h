/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/xpcom/io/nsIDirectoryService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDirectoryServiceProvider : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFile(const char * prop, PRBool *persistent NS_OUTPARAM, nsIFile * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDIRECTORYSERVICEPROVIDER \
  NS_SCRIPTABLE NS_IMETHOD GetFile(const char * prop, PRBool *persistent NS_OUTPARAM, nsIFile * *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDIRECTORYSERVICEPROVIDER(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetFile(const char * prop, PRBool *persistent NS_OUTPARAM, nsIFile * *_retval NS_OUTPARAM) { return _to GetFile(prop, persistent, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDIRECTORYSERVICEPROVIDER(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetFile(const char * prop, PRBool *persistent NS_OUTPARAM, nsIFile * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFile(prop, persistent, _retval); } 
...
/* nsIFile getFile (in string prop, out boolean persistent); */
NS_IMETHODIMP nsDirectoryServiceProvider::GetFile(const char * prop, PRBool *persistent NS_OUTPARAM, nsIFile * *_retval NS_OUTPARAM)
{
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDirectoryServiceProvider2 : public nsIDirectoryServiceProvider {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFiles(const char * prop, nsISimpleEnumerator * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDIRECTORYSERVICEPROVIDER2 \
  NS_SCRIPTABLE NS_IMETHOD GetFiles(const char * prop, nsISimpleEnumerator * *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDIRECTORYSERVICEPROVIDER2(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetFiles(const char * prop, nsISimpleEnumerator * *_retval NS_OUTPARAM) { return _to GetFiles(prop, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDIRECTORYSERVICEPROVIDER2(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetFiles(const char * prop, nsISimpleEnumerator * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFiles(prop, _retval); } 
...
/* nsISimpleEnumerator getFiles (in string prop); */
NS_IMETHODIMP nsDirectoryServiceProvider2::GetFiles(const char * prop, nsISimpleEnumerator * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
