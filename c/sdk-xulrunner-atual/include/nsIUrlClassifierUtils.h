/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/toolkit/components/url-classifier/nsIUrlClassifierUtils.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIUrlClassifierUtils : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IURLCLASSIFIERUTILS_IID)

  /* ACString getKeyForURI (in nsIURI uri); */
  NS_SCRIPTABLE NS_IMETHOD GetKeyForURI(nsIURI *uri, nsACString & _retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIURLCLASSIFIERUTILS \
  NS_SCRIPTABLE NS_IMETHOD GetKeyForURI(nsIURI *uri, nsACString & _retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIURLCLASSIFIERUTILS(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetKeyForURI(nsIURI *uri, nsACString & _retval NS_OUTPARAM) { return _to GetKeyForURI(uri, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIURLCLASSIFIERUTILS(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetKeyForURI(nsIURI *uri, nsACString & _retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetKeyForURI(uri, _retval); } 
...
/* ACString getKeyForURI (in nsIURI uri); */
NS_IMETHODIMP nsUrlClassifierUtils::GetKeyForURI(nsIURI *uri, nsACString & _retval NS_OUTPARAM)
{
