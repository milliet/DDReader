...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMElement : public nsIDOMNode {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD HasAttribute(const nsAString & name, PRBool *_retval NS_OUTPARAM) = 0;

  /* boolean hasAttributeNS (in DOMString namespaceURI, in DOMString localName); */
  NS_SCRIPTABLE NS_IMETHOD HasAttributeNS(const nsAString & namespaceURI, const nsAString & localName, PRBool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOMELEMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasAttribute(const nsAString & name, PRBool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD HasAttributeNS(const nsAString & namespaceURI, const nsAString & localName, PRBool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIDOMELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasAttribute(const nsAString & name, PRBool *_retval NS_OUTPARAM) { return _to HasAttribute(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD HasAttributeNS(const nsAString & namespaceURI, const nsAString & localName, PRBool *_retval NS_OUTPARAM) { return _to HasAttributeNS(namespaceURI, localName, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasAttribute(const nsAString & name, PRBool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasAttribute(name, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD HasAttributeNS(const nsAString & namespaceURI, const nsAString & localName, PRBool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasAttributeNS(namespaceURI, localName, _retval); } 
...
/* boolean hasAttribute (in DOMString name); */
NS_IMETHODIMP nsDOMElement::HasAttribute(const nsAString & name, PRBool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean hasAttributeNS (in DOMString namespaceURI, in DOMString localName); */
NS_IMETHODIMP nsDOMElement::HasAttributeNS(const nsAString & namespaceURI, const nsAString & localName, PRBool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
