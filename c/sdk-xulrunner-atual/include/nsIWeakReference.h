/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/xpcom/base/nsIWeakReference.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIWeakReference : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD QueryReferent(const nsIID & uuid, void **result NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIWEAKREFERENCE \
  NS_SCRIPTABLE NS_IMETHOD QueryReferent(const nsIID & uuid, void **result NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIWEAKREFERENCE(_to) \
  NS_SCRIPTABLE NS_IMETHOD QueryReferent(const nsIID & uuid, void **result NS_OUTPARAM) { return _to QueryReferent(uuid, result); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIWEAKREFERENCE(_to) \
  NS_SCRIPTABLE NS_IMETHOD QueryReferent(const nsIID & uuid, void **result NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->QueryReferent(uuid, result); } 
...
/* void QueryReferent (in nsIIDRef uuid, [iid_is (uuid), retval] out nsQIResult result); */
NS_IMETHODIMP nsWeakReference::QueryReferent(const nsIID & uuid, void **result NS_OUTPARAM)
{
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISupportsWeakReference : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetWeakReference(nsIWeakReference * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSISUPPORTSWEAKREFERENCE \
  NS_SCRIPTABLE NS_IMETHOD GetWeakReference(nsIWeakReference * *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISUPPORTSWEAKREFERENCE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetWeakReference(nsIWeakReference * *_retval NS_OUTPARAM) { return _to GetWeakReference(_retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISUPPORTSWEAKREFERENCE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetWeakReference(nsIWeakReference * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetWeakReference(_retval); } 
...
/* nsIWeakReference GetWeakReference (); */
NS_IMETHODIMP nsSupportsWeakReference::GetWeakReference(nsIWeakReference * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
