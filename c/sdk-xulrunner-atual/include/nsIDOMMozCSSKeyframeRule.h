/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/interfaces/css/nsIDOMMozCSSKeyframeRule.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMMozCSSKeyframeRule : public nsIDOMCSSRule {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOMMOZCSSKEYFRAMERULE_IID)

  /* attribute DOMString keyText; */
  NS_SCRIPTABLE NS_IMETHOD GetKeyText(nsAString & aKeyText) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetKeyText(const nsAString & aKeyText) = 0;
...
#define NS_DECL_NSIDOMMOZCSSKEYFRAMERULE \
  NS_SCRIPTABLE NS_IMETHOD GetKeyText(nsAString & aKeyText); \
  NS_SCRIPTABLE NS_IMETHOD SetKeyText(const nsAString & aKeyText); \
...
#define NS_FORWARD_NSIDOMMOZCSSKEYFRAMERULE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetKeyText(nsAString & aKeyText) { return _to GetKeyText(aKeyText); } \
  NS_SCRIPTABLE NS_IMETHOD SetKeyText(const nsAString & aKeyText) { return _to SetKeyText(aKeyText); } \
...
#define NS_FORWARD_SAFE_NSIDOMMOZCSSKEYFRAMERULE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetKeyText(nsAString & aKeyText) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetKeyText(aKeyText); } \
  NS_SCRIPTABLE NS_IMETHOD SetKeyText(const nsAString & aKeyText) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetKeyText(aKeyText); } \
