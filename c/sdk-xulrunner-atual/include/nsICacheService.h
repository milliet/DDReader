/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/netwerk/cache/nsICacheService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICacheService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCacheIOTarget(nsIEventTarget * *aCacheIOTarget) = 0;
...
#define NS_DECL_NSICACHESERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCacheIOTarget(nsIEventTarget * *aCacheIOTarget); 
...
#define NS_FORWARD_NSICACHESERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCacheIOTarget(nsIEventTarget * *aCacheIOTarget) { return _to GetCacheIOTarget(aCacheIOTarget); } 
...
#define NS_FORWARD_SAFE_NSICACHESERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCacheIOTarget(nsIEventTarget * *aCacheIOTarget) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCacheIOTarget(aCacheIOTarget); } 
