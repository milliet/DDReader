/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/netwerk/protocol/ftp/nsIFTPChannel.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFTPChannel : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SetLastModifiedTime(PRTime aLastModifiedTime) = 0;
...
#define NS_DECL_NSIFTPCHANNEL \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetLastModifiedTime(PRTime aLastModifiedTime); 
...
#define NS_FORWARD_NSIFTPCHANNEL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetLastModifiedTime(PRTime aLastModifiedTime) { return _to SetLastModifiedTime(aLastModifiedTime); } 
...
#define NS_FORWARD_SAFE_NSIFTPCHANNEL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetLastModifiedTime(PRTime aLastModifiedTime) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetLastModifiedTime(aLastModifiedTime); } 
