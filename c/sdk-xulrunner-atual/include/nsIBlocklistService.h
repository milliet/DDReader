/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/xpcom/system/nsIBlocklistService.idl
 */
...
#define NS_IBLOCKLISTSERVICE_IID_STR "31845f85-718a-4581-a672-a45c0327cb21"

#define NS_IBLOCKLISTSERVICE_IID \
  {0x31845f85, 0x718a, 0x4581, \
    { 0xa6, 0x72, 0xa4, 0x5c, 0x03, 0x27, 0xcb, 0x21 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIBlocklistService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAddonBlocklistURL(const nsAString & id, const nsAString & version, const nsAString & appVersion, const nsAString & toolkitVersion, nsAString & _retval NS_OUTPARAM) = 0;

  /* AString getPluginBlocklistURL (in nsIPluginTag plugin); */
  NS_SCRIPTABLE NS_IMETHOD GetPluginBlocklistURL(nsIPluginTag *plugin, nsAString & _retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIBLOCKLISTSERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAddonBlocklistURL(const nsAString & id, const nsAString & version, const nsAString & appVersion, const nsAString & toolkitVersion, nsAString & _retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD GetPluginBlocklistURL(nsIPluginTag *plugin, nsAString & _retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIBLOCKLISTSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAddonBlocklistURL(const nsAString & id, const nsAString & version, const nsAString & appVersion, const nsAString & toolkitVersion, nsAString & _retval NS_OUTPARAM) { return _to GetAddonBlocklistURL(id, version, appVersion, toolkitVersion, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetPluginBlocklistURL(nsIPluginTag *plugin, nsAString & _retval NS_OUTPARAM) { return _to GetPluginBlocklistURL(plugin, _retval); } 
...
#define NS_FORWARD_SAFE_NSIBLOCKLISTSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAddonBlocklistURL(const nsAString & id, const nsAString & version, const nsAString & appVersion, const nsAString & toolkitVersion, nsAString & _retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAddonBlocklistURL(id, version, appVersion, toolkitVersion, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetPluginBlocklistURL(nsIPluginTag *plugin, nsAString & _retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPluginBlocklistURL(plugin, _retval); } 
...
/* AString getAddonBlocklistURL (in AString id, in AString version, [optional] in AString appVersion, [optional] in AString toolkitVersion); */
NS_IMETHODIMP nsBlocklistService::GetAddonBlocklistURL(const nsAString & id, const nsAString & version, const nsAString & appVersion, const nsAString & toolkitVersion, nsAString & _retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* AString getPluginBlocklistURL (in nsIPluginTag plugin); */
NS_IMETHODIMP nsBlocklistService::GetPluginBlocklistURL(nsIPluginTag *plugin, nsAString & _retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
