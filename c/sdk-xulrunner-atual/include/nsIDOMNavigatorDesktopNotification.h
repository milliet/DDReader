/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/interfaces/notification/nsIDOMNavigatorDesktopNotification.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMNavigatorDesktopNotification : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozNotification(nsIDOMDesktopNotificationCenter * *aMozNotification) = 0;
...
#define NS_DECL_NSIDOMNAVIGATORDESKTOPNOTIFICATION \
  NS_SCRIPTABLE NS_IMETHOD GetMozNotification(nsIDOMDesktopNotificationCenter * *aMozNotification); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMNAVIGATORDESKTOPNOTIFICATION(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetMozNotification(nsIDOMDesktopNotificationCenter * *aMozNotification) { return _to GetMozNotification(aMozNotification); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMNAVIGATORDESKTOPNOTIFICATION(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetMozNotification(nsIDOMDesktopNotificationCenter * *aMozNotification) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozNotification(aMozNotification); } 
