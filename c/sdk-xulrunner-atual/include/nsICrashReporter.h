/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/xpcom/system/nsICrashReporter.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICrashReporter : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD RegisterAppMemory(PRUint64 ptr, PRUint64 size) = 0;
...
#define NS_DECL_NSICRASHREPORTER \
  ...
  NS_SCRIPTABLE NS_IMETHOD RegisterAppMemory(PRUint64 ptr, PRUint64 size); \
...
#define NS_FORWARD_NSICRASHREPORTER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD RegisterAppMemory(PRUint64 ptr, PRUint64 size) { return _to RegisterAppMemory(ptr, size); } \
...
#define NS_FORWARD_SAFE_NSICRASHREPORTER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD RegisterAppMemory(PRUint64 ptr, PRUint64 size) { return !_to ? NS_ERROR_NULL_POINTER : _to->RegisterAppMemory(ptr, size); } \
...
/* void registerAppMemory (in unsigned long long ptr, in unsigned long long size); */
NS_IMETHODIMP nsCrashReporter::RegisterAppMemory(PRUint64 ptr, PRUint64 size)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
