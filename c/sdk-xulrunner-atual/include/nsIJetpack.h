/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/js/jetpack/nsIJetpack.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIJetpack : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD RegisterReceiver(const nsAString & aMessageName, const JS::Value & aReceiver) = 0;

  /* void unregisterReceiver (in AString aMessageName, in jsval aReceiver); */
  NS_SCRIPTABLE NS_IMETHOD UnregisterReceiver(const nsAString & aMessageName, const JS::Value & aReceiver) = 0;
...
#define NS_DECL_NSIJETPACK \
  ...
  NS_SCRIPTABLE NS_IMETHOD RegisterReceiver(const nsAString & aMessageName, const JS::Value & aReceiver); \
  NS_SCRIPTABLE NS_IMETHOD UnregisterReceiver(const nsAString & aMessageName, const JS::Value & aReceiver); \
...
#define NS_FORWARD_NSIJETPACK(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD RegisterReceiver(const nsAString & aMessageName, const JS::Value & aReceiver) { return _to RegisterReceiver(aMessageName, aReceiver); } \
  NS_SCRIPTABLE NS_IMETHOD UnregisterReceiver(const nsAString & aMessageName, const JS::Value & aReceiver) { return _to UnregisterReceiver(aMessageName, aReceiver); } \
...
#define NS_FORWARD_SAFE_NSIJETPACK(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD RegisterReceiver(const nsAString & aMessageName, const JS::Value & aReceiver) { return !_to ? NS_ERROR_NULL_POINTER : _to->RegisterReceiver(aMessageName, aReceiver); } \
  NS_SCRIPTABLE NS_IMETHOD UnregisterReceiver(const nsAString & aMessageName, const JS::Value & aReceiver) { return !_to ? NS_ERROR_NULL_POINTER : _to->UnregisterReceiver(aMessageName, aReceiver); } \
...
/* void registerReceiver (in AString aMessageName, in jsval aReceiver); */
NS_IMETHODIMP nsJetpack::RegisterReceiver(const nsAString & aMessageName, const JS::Value & aReceiver)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void unregisterReceiver (in AString aMessageName, in jsval aReceiver); */
NS_IMETHODIMP nsJetpack::UnregisterReceiver(const nsAString & aMessageName, const JS::Value & aReceiver)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
