/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/content/html/content/public/nsIFormSubmitObserver.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFormSubmitObserver : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Notify(nsIDOMHTMLFormElement *formNode, nsIDOMWindow *window, nsIURI *actionURL, PRBool *cancelSubmit NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIFORMSUBMITOBSERVER \
  NS_SCRIPTABLE NS_IMETHOD Notify(nsIDOMHTMLFormElement *formNode, nsIDOMWindow *window, nsIURI *actionURL, PRBool *cancelSubmit NS_OUTPARAM); \
...
#define NS_FORWARD_NSIFORMSUBMITOBSERVER(_to) \
  NS_SCRIPTABLE NS_IMETHOD Notify(nsIDOMHTMLFormElement *formNode, nsIDOMWindow *window, nsIURI *actionURL, PRBool *cancelSubmit NS_OUTPARAM) { return _to Notify(formNode, window, actionURL, cancelSubmit); } \
...
#define NS_FORWARD_SAFE_NSIFORMSUBMITOBSERVER(_to) \
  NS_SCRIPTABLE NS_IMETHOD Notify(nsIDOMHTMLFormElement *formNode, nsIDOMWindow *window, nsIURI *actionURL, PRBool *cancelSubmit NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Notify(formNode, window, actionURL, cancelSubmit); } \
...
/* void notify (in nsIDOMHTMLFormElement formNode, in nsIDOMWindow window, in nsIURI actionURL, out boolean cancelSubmit); */
NS_IMETHODIMP nsFormSubmitObserver::Notify(nsIDOMHTMLFormElement *formNode, nsIDOMWindow *window, nsIURI *actionURL, PRBool *cancelSubmit NS_OUTPARAM)
{
