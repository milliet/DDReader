/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/xpcom/components/nsICategoryManager.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICategoryManager : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD AddCategoryEntry(const char * aCategory, const char * aEntry, const char * aValue, PRBool aPersist, PRBool aReplace, char * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSICATEGORYMANAGER \
  ...
  NS_SCRIPTABLE NS_IMETHOD AddCategoryEntry(const char * aCategory, const char * aEntry, const char * aValue, PRBool aPersist, PRBool aReplace, char * *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSICATEGORYMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD AddCategoryEntry(const char * aCategory, const char * aEntry, const char * aValue, PRBool aPersist, PRBool aReplace, char * *_retval NS_OUTPARAM) { return _to AddCategoryEntry(aCategory, aEntry, aValue, aPersist, aReplace, _retval); } \
...
#define NS_FORWARD_SAFE_NSICATEGORYMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD AddCategoryEntry(const char * aCategory, const char * aEntry, const char * aValue, PRBool aPersist, PRBool aReplace, char * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddCategoryEntry(aCategory, aEntry, aValue, aPersist, aReplace, _retval); } \
...
/* string addCategoryEntry (in string aCategory, in string aEntry, in string aValue, in boolean aPersist, in boolean aReplace); */
NS_IMETHODIMP nsCategoryManager::AddCategoryEntry(const char * aCategory, const char * aEntry, const char * aValue, PRBool aPersist, PRBool aReplace, char * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
