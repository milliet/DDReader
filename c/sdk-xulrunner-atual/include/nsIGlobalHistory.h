/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/docshell/base/nsIGlobalHistory.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIGlobalHistory : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsVisited(const char * aURL, PRBool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIGLOBALHISTORY \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsVisited(const char * aURL, PRBool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIGLOBALHISTORY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsVisited(const char * aURL, PRBool *_retval NS_OUTPARAM) { return _to IsVisited(aURL, _retval); } 
...
#define NS_FORWARD_SAFE_NSIGLOBALHISTORY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsVisited(const char * aURL, PRBool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsVisited(aURL, _retval); } 
...
/* boolean isVisited (in string aURL); */
NS_IMETHODIMP nsGlobalHistory::IsVisited(const char * aURL, PRBool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
