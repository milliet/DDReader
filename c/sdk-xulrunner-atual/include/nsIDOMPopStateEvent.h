...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMPopStateEvent : public nsIDOMEvent {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD InitPopStateEvent(const nsAString & typeArg, PRBool canBubbleArg, PRBool cancelableArg, nsIVariant *stateArg) = 0;
...
#define NS_DECL_NSIDOMPOPSTATEEVENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD InitPopStateEvent(const nsAString & typeArg, PRBool canBubbleArg, PRBool cancelableArg, nsIVariant *stateArg); 
...
#define NS_FORWARD_NSIDOMPOPSTATEEVENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD InitPopStateEvent(const nsAString & typeArg, PRBool canBubbleArg, PRBool cancelableArg, nsIVariant *stateArg) { return _to InitPopStateEvent(typeArg, canBubbleArg, cancelableArg, stateArg); } 
...
#define NS_FORWARD_SAFE_NSIDOMPOPSTATEEVENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD InitPopStateEvent(const nsAString & typeArg, PRBool canBubbleArg, PRBool cancelableArg, nsIVariant *stateArg) { return !_to ? NS_ERROR_NULL_POINTER : _to->InitPopStateEvent(typeArg, canBubbleArg, cancelableArg, stateArg); } 
