/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/widget/public/nsIJumpListItem.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIJumpListShortcut : public nsIJumpListItem {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFaviconPageUri(nsIURI * *aFaviconPageUri) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetFaviconPageUri(nsIURI *aFaviconPageUri) = 0;
...
#define NS_DECL_NSIJUMPLISTSHORTCUT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFaviconPageUri(nsIURI * *aFaviconPageUri); \
  NS_SCRIPTABLE NS_IMETHOD SetFaviconPageUri(nsIURI *aFaviconPageUri); 
...
#define NS_FORWARD_NSIJUMPLISTSHORTCUT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFaviconPageUri(nsIURI * *aFaviconPageUri) { return _to GetFaviconPageUri(aFaviconPageUri); } \
  NS_SCRIPTABLE NS_IMETHOD SetFaviconPageUri(nsIURI *aFaviconPageUri) { return _to SetFaviconPageUri(aFaviconPageUri); } 
...
#define NS_FORWARD_SAFE_NSIJUMPLISTSHORTCUT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFaviconPageUri(nsIURI * *aFaviconPageUri) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFaviconPageUri(aFaviconPageUri); } \
  NS_SCRIPTABLE NS_IMETHOD SetFaviconPageUri(nsIURI *aFaviconPageUri) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetFaviconPageUri(aFaviconPageUri); } 
