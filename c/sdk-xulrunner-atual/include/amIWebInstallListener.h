/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/toolkit/mozapps/extensions/amIWebInstallListener.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE amIWebInstallInfo : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetOriginatingWindow(nsIDOMWindow * *aOriginatingWindow) = 0;
...
#define NS_DECL_AMIWEBINSTALLINFO \
  NS_SCRIPTABLE NS_IMETHOD GetOriginatingWindow(nsIDOMWindow * *aOriginatingWindow); \
...
#define NS_FORWARD_AMIWEBINSTALLINFO(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetOriginatingWindow(nsIDOMWindow * *aOriginatingWindow) { return _to GetOriginatingWindow(aOriginatingWindow); } \
...
#define NS_FORWARD_SAFE_AMIWEBINSTALLINFO(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetOriginatingWindow(nsIDOMWindow * *aOriginatingWindow) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOriginatingWindow(aOriginatingWindow); } \
...
class NS_NO_VTABLE NS_SCRIPTABLE amIWebInstallListener : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD OnWebInstallDisabled(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD OnWebInstallBlocked(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount, PRBool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD OnWebInstallRequested(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount, PRBool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_AMIWEBINSTALLLISTENER \
  NS_SCRIPTABLE NS_IMETHOD OnWebInstallDisabled(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount); \
  NS_SCRIPTABLE NS_IMETHOD OnWebInstallBlocked(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount, PRBool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD OnWebInstallRequested(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount, PRBool *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_AMIWEBINSTALLLISTENER(_to) \
  NS_SCRIPTABLE NS_IMETHOD OnWebInstallDisabled(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount) { return _to OnWebInstallDisabled(aWindow, aUri, aInstalls, aCount); } \
  NS_SCRIPTABLE NS_IMETHOD OnWebInstallBlocked(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount, PRBool *_retval NS_OUTPARAM) { return _to OnWebInstallBlocked(aWindow, aUri, aInstalls, aCount, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD OnWebInstallRequested(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount, PRBool *_retval NS_OUTPARAM) { return _to OnWebInstallRequested(aWindow, aUri, aInstalls, aCount, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_AMIWEBINSTALLLISTENER(_to) \
  NS_SCRIPTABLE NS_IMETHOD OnWebInstallDisabled(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnWebInstallDisabled(aWindow, aUri, aInstalls, aCount); } \
  NS_SCRIPTABLE NS_IMETHOD OnWebInstallBlocked(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount, PRBool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnWebInstallBlocked(aWindow, aUri, aInstalls, aCount, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD OnWebInstallRequested(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount, PRBool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnWebInstallRequested(aWindow, aUri, aInstalls, aCount, _retval); } 
...
/* void onWebInstallDisabled (in nsIDOMWindow aWindow, in nsIURI aUri, [array, size_is (aCount)] in nsIVariant aInstalls, [optional] in PRUint32 aCount); */
NS_IMETHODIMP amWebInstallListener::OnWebInstallDisabled(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean onWebInstallBlocked (in nsIDOMWindow aWindow, in nsIURI aUri, [array, size_is (aCount)] in nsIVariant aInstalls, [optional] in PRUint32 aCount); */
NS_IMETHODIMP amWebInstallListener::OnWebInstallBlocked(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount, PRBool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean onWebInstallRequested (in nsIDOMWindow aWindow, in nsIURI aUri, [array, size_is (aCount)] in nsIVariant aInstalls, [optional] in PRUint32 aCount); */
NS_IMETHODIMP amWebInstallListener::OnWebInstallRequested(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount, PRBool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE NS_SCRIPTABLE amIWebInstallPrompt : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Confirm(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount) = 0;
...
#define NS_DECL_AMIWEBINSTALLPROMPT \
  NS_SCRIPTABLE NS_IMETHOD Confirm(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_AMIWEBINSTALLPROMPT(_to) \
  NS_SCRIPTABLE NS_IMETHOD Confirm(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount) { return _to Confirm(aWindow, aUri, aInstalls, aCount); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_AMIWEBINSTALLPROMPT(_to) \
  NS_SCRIPTABLE NS_IMETHOD Confirm(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount) { return !_to ? NS_ERROR_NULL_POINTER : _to->Confirm(aWindow, aUri, aInstalls, aCount); } 
...
/* void confirm (in nsIDOMWindow aWindow, in nsIURI aUri, [array, size_is (aCount)] in nsIVariant aInstalls, [optional] in PRUint32 aCount); */
NS_IMETHODIMP amWebInstallPrompt::Confirm(nsIDOMWindow *aWindow, nsIURI *aUri, nsIVariant **aInstalls, PRUint32 aCount)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
