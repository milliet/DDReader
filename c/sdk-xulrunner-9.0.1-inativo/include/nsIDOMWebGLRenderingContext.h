...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMWebGLRenderingContext : public nsISupports {
 public: 
  ...
  /* [noscript] void readPixels_buf (in WebGLint x, in WebGLint y, in WebGLsizei width, in WebGLsizei height, in WebGLenum format, in WebGLenum type, in WebGLJSObjectPtr pixels); */
  NS_IMETHOD ReadPixels_buf(WebGLint x, WebGLint y, WebGLsizei width, WebGLsizei height, WebGLenum format, WebGLenum type, JSObject *pixels) = 0;
  ...
  /* [noscript] void texImage2D_buf (in WebGLenum target, in WebGLint level, in WebGLenum internalformat, in WebGLsizei width, in WebGLsizei height, in WebGLint border, in WebGLenum format, in WebGLenum type, in WebGLJSObjectPtr pixels); */
  NS_IMETHOD TexImage2D_buf(WebGLenum target, WebGLint level, WebGLenum internalformat, WebGLsizei width, WebGLsizei height, WebGLint border, WebGLenum format, WebGLenum type, JSObject *pixels) = 0;
  ...
  /* [noscript] void texSubImage2D_buf (in WebGLenum target, in WebGLint level, in WebGLint xoffset, in WebGLint yoffset, in WebGLsizei width, in WebGLsizei height, in WebGLenum format, in WebGLenum type, in WebGLJSObjectPtr pixels); */
  NS_IMETHOD TexSubImage2D_buf(WebGLenum target, WebGLint level, WebGLint xoffset, WebGLint yoffset, WebGLsizei width, WebGLsizei height, WebGLenum format, WebGLenum type, JSObject *pixels) = 0;
...
#define NS_DECL_NSIDOMWEBGLRENDERINGCONTEXT \
  ...
  NS_IMETHOD ReadPixels_buf(WebGLint x, WebGLint y, WebGLsizei width, WebGLsizei height, WebGLenum format, WebGLenum type, JSObject *pixels); \
  ...
  NS_IMETHOD TexImage2D_buf(WebGLenum target, WebGLint level, WebGLenum internalformat, WebGLsizei width, WebGLsizei height, WebGLint border, WebGLenum format, WebGLenum type, JSObject *pixels); \
  ...
  NS_IMETHOD TexSubImage2D_buf(WebGLenum target, WebGLint level, WebGLint xoffset, WebGLint yoffset, WebGLsizei width, WebGLsizei height, WebGLenum format, WebGLenum type, JSObject *pixels); \
...
#define NS_FORWARD_NSIDOMWEBGLRENDERINGCONTEXT(_to) \
  ...
  NS_IMETHOD ReadPixels_buf(WebGLint x, WebGLint y, WebGLsizei width, WebGLsizei height, WebGLenum format, WebGLenum type, JSObject *pixels) { return _to ReadPixels_buf(x, y, width, height, format, type, pixels); } \
  ...
  NS_IMETHOD TexImage2D_buf(WebGLenum target, WebGLint level, WebGLenum internalformat, WebGLsizei width, WebGLsizei height, WebGLint border, WebGLenum format, WebGLenum type, JSObject *pixels) { return _to TexImage2D_buf(target, level, internalformat, width, height, border, format, type, pixels); } \
  ...
  NS_IMETHOD TexSubImage2D_buf(WebGLenum target, WebGLint level, WebGLint xoffset, WebGLint yoffset, WebGLsizei width, WebGLsizei height, WebGLenum format, WebGLenum type, JSObject *pixels) { return _to TexSubImage2D_buf(target, level, xoffset, yoffset, width, height, format, type, pixels); } \
...
#define NS_FORWARD_SAFE_NSIDOMWEBGLRENDERINGCONTEXT(_to) \
  ...
  NS_IMETHOD ReadPixels_buf(WebGLint x, WebGLint y, WebGLsizei width, WebGLsizei height, WebGLenum format, WebGLenum type, JSObject *pixels) { return !_to ? NS_ERROR_NULL_POINTER : _to->ReadPixels_buf(x, y, width, height, format, type, pixels); } \
  ...
  NS_IMETHOD TexImage2D_buf(WebGLenum target, WebGLint level, WebGLenum internalformat, WebGLsizei width, WebGLsizei height, WebGLint border, WebGLenum format, WebGLenum type, JSObject *pixels) { return !_to ? NS_ERROR_NULL_POINTER : _to->TexImage2D_buf(target, level, internalformat, width, height, border, format, type, pixels); } \
  ...
  NS_IMETHOD TexSubImage2D_buf(WebGLenum target, WebGLint level, WebGLint xoffset, WebGLint yoffset, WebGLsizei width, WebGLsizei height, WebGLenum format, WebGLenum type, JSObject *pixels) { return !_to ? NS_ERROR_NULL_POINTER : _to->TexSubImage2D_buf(target, level, xoffset, yoffset, width, height, format, type, pixels); } \
...
/* [noscript] void readPixels_buf (in WebGLint x, in WebGLint y, in WebGLsizei width, in WebGLsizei height, in WebGLenum format, in WebGLenum type, in WebGLJSObjectPtr pixels); */
NS_IMETHODIMP nsDOMWebGLRenderingContext::ReadPixels_buf(WebGLint x, WebGLint y, WebGLsizei width, WebGLsizei height, WebGLenum format, WebGLenum type, JSObject *pixels)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* [noscript] void texImage2D_buf (in WebGLenum target, in WebGLint level, in WebGLenum internalformat, in WebGLsizei width, in WebGLsizei height, in WebGLint border, in WebGLenum format, in WebGLenum type, in WebGLJSObjectPtr pixels); */
NS_IMETHODIMP nsDOMWebGLRenderingContext::TexImage2D_buf(WebGLenum target, WebGLint level, WebGLenum internalformat, WebGLsizei width, WebGLsizei height, WebGLint border, WebGLenum format, WebGLenum type, JSObject *pixels)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* [noscript] void texSubImage2D_buf (in WebGLenum target, in WebGLint level, in WebGLint xoffset, in WebGLint yoffset, in WebGLsizei width, in WebGLsizei height, in WebGLenum format, in WebGLenum type, in WebGLJSObjectPtr pixels); */
NS_IMETHODIMP nsDOMWebGLRenderingContext::TexSubImage2D_buf(WebGLenum target, WebGLint level, WebGLint xoffset, WebGLint yoffset, WebGLsizei width, WebGLsizei height, WebGLenum format, WebGLenum type, JSObject *pixels)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
