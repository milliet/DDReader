/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/netwerk/base/public/nsIUploadChannel2.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIUploadChannel2 : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUploadStreamHasHeaders(PRBool *aUploadStreamHasHeaders) = 0;
...
#define NS_DECL_NSIUPLOADCHANNEL2 \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUploadStreamHasHeaders(PRBool *aUploadStreamHasHeaders); 
...
#define NS_FORWARD_NSIUPLOADCHANNEL2(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUploadStreamHasHeaders(PRBool *aUploadStreamHasHeaders) { return _to GetUploadStreamHasHeaders(aUploadStreamHasHeaders); } 
...
#define NS_FORWARD_SAFE_NSIUPLOADCHANNEL2(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUploadStreamHasHeaders(PRBool *aUploadStreamHasHeaders) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUploadStreamHasHeaders(aUploadStreamHasHeaders); } 
...
/* readonly attribute boolean uploadStreamHasHeaders; */
NS_IMETHODIMP nsUploadChannel2::GetUploadStreamHasHeaders(PRBool *aUploadStreamHasHeaders)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
