/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/chrome/public/nsIChromeRegistry.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIXULChromeRegistry : public nsIChromeRegistry {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsLocaleRTL(const nsACString & package, PRBool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIXULCHROMEREGISTRY \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsLocaleRTL(const nsACString & package, PRBool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIXULCHROMEREGISTRY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsLocaleRTL(const nsACString & package, PRBool *_retval NS_OUTPARAM) { return _to IsLocaleRTL(package, _retval); } \
...
#define NS_FORWARD_SAFE_NSIXULCHROMEREGISTRY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsLocaleRTL(const nsACString & package, PRBool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsLocaleRTL(package, _retval); } \
...
/* boolean isLocaleRTL (in ACString package); */
NS_IMETHODIMP nsXULChromeRegistry::IsLocaleRTL(const nsACString & package, PRBool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
