/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/netwerk/base/public/nsIProxyInfo.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIProxyInfo : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetResolveFlags(PRUint32 *aResolveFlags) = 0;
...
#define NS_DECL_NSIPROXYINFO \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetResolveFlags(PRUint32 *aResolveFlags); \
...
#define NS_FORWARD_NSIPROXYINFO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetResolveFlags(PRUint32 *aResolveFlags) { return _to GetResolveFlags(aResolveFlags); } \
...
#define NS_FORWARD_SAFE_NSIPROXYINFO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetResolveFlags(PRUint32 *aResolveFlags) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetResolveFlags(aResolveFlags); } \
...
/* readonly attribute unsigned long resolveFlags; */
NS_IMETHODIMP nsProxyInfo::GetResolveFlags(PRUint32 *aResolveFlags)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
