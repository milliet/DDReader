/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/indexedDB/nsIIDBCursorWithValue.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIIDBCursorWithValue : public nsIIDBCursor {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetValue(JSContext* cx, JS::Value *aValue) = 0;
...
#define NS_DECL_NSIIDBCURSORWITHVALUE \
  NS_SCRIPTABLE NS_IMETHOD GetValue(JSContext* cx, JS::Value *aValue); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIIDBCURSORWITHVALUE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetValue(JSContext* cx, JS::Value *aValue) { return _to GetValue(cx, aValue); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIIDBCURSORWITHVALUE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetValue(JSContext* cx, JS::Value *aValue) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetValue(cx, aValue); } 
