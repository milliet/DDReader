/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/js/src/xpconnect/idl/xpcIJSGetFactory.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE xpcIJSGetFactory : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(XPCIJSGETFACTORY_IID)

  /* nsIFactory get (in nsCIDRef aCID); */
  NS_SCRIPTABLE NS_IMETHOD Get(const nsCID & aCID, nsIFactory * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_XPCIJSGETFACTORY \
  NS_SCRIPTABLE NS_IMETHOD Get(const nsCID & aCID, nsIFactory * *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_XPCIJSGETFACTORY(_to) \
  NS_SCRIPTABLE NS_IMETHOD Get(const nsCID & aCID, nsIFactory * *_retval NS_OUTPARAM) { return _to Get(aCID, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_XPCIJSGETFACTORY(_to) \
  NS_SCRIPTABLE NS_IMETHOD Get(const nsCID & aCID, nsIFactory * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Get(aCID, _retval); } 
...
/* nsIFactory get (in nsCIDRef aCID); */
NS_IMETHODIMP _MYCLASS_::Get(const nsCID & aCID, nsIFactory * *_retval NS_OUTPARAM)
{
