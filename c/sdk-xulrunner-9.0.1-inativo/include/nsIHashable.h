/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/xpcom/ds/nsIHashable.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIHashable : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIHashable *aOther, PRBool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIHASHABLE \
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIHashable *aOther, PRBool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD GetHashCode(PRUint32 *aHashCode); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIHASHABLE(_to) \
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIHashable *aOther, PRBool *_retval NS_OUTPARAM) { return _to Equals(aOther, _retval); } \
...
#define NS_FORWARD_SAFE_NSIHASHABLE(_to) \
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIHashable *aOther, PRBool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Equals(aOther, _retval); } \
...
/* boolean equals (in nsIHashable aOther); */
NS_IMETHODIMP nsHashable::Equals(nsIHashable *aOther, PRBool *_retval NS_OUTPARAM)
{
