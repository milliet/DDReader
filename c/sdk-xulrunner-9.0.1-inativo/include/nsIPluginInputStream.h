/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/plugins/base/nsIPluginInputStream.idl
 */
...
class NS_NO_VTABLE nsIPluginInputStream : public nsIInputStream {
 public: 
  ...
  NS_IMETHOD RequestRead(NPByteRange *aRangeList NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIPLUGININPUTSTREAM \
  ...
  NS_IMETHOD RequestRead(NPByteRange *aRangeList NS_OUTPARAM); 
...
#define NS_FORWARD_NSIPLUGININPUTSTREAM(_to) \
  ...
  NS_IMETHOD RequestRead(NPByteRange *aRangeList NS_OUTPARAM) { return _to RequestRead(aRangeList); } 
...
#define NS_FORWARD_SAFE_NSIPLUGININPUTSTREAM(_to) \
  ...
  NS_IMETHOD RequestRead(NPByteRange *aRangeList NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->RequestRead(aRangeList); } 
...
/* void requestRead (out NPByteRange aRangeList); */
NS_IMETHODIMP nsPluginInputStream::RequestRead(NPByteRange *aRangeList NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
