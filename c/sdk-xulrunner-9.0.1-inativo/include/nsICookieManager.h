/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/netwerk/cookie/nsICookieManager.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsICookieManager : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Remove(const nsACString & aHost, const nsACString & aName, const nsACString & aPath, PRBool aBlocked) = 0;
...
#define NS_DECL_NSICOOKIEMANAGER \
  ...
  NS_SCRIPTABLE NS_IMETHOD Remove(const nsACString & aHost, const nsACString & aName, const nsACString & aPath, PRBool aBlocked); 
...
#define NS_FORWARD_NSICOOKIEMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Remove(const nsACString & aHost, const nsACString & aName, const nsACString & aPath, PRBool aBlocked) { return _to Remove(aHost, aName, aPath, aBlocked); } 
...
#define NS_FORWARD_SAFE_NSICOOKIEMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Remove(const nsACString & aHost, const nsACString & aName, const nsACString & aPath, PRBool aBlocked) { return !_to ? NS_ERROR_NULL_POINTER : _to->Remove(aHost, aName, aPath, aBlocked); } 
...
/* void remove (in AUTF8String aHost, in ACString aName, in AUTF8String aPath, in boolean aBlocked); */
NS_IMETHODIMP nsCookieManager::Remove(const nsACString & aHost, const nsACString & aName, const nsACString & aPath, PRBool aBlocked)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
