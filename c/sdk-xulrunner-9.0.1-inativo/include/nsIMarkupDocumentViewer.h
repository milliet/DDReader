/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/docshell/base/nsIMarkupDocumentViewer.idl
 */
...
#define NS_IMARKUPDOCUMENTVIEWER_IID_STR "79286cd6-8293-4def-ba26-76422efc3d2a"

#define NS_IMARKUPDOCUMENTVIEWER_IID \
  {0x79286cd6, 0x8293, 0x4def, \
    { 0xba, 0x26, 0x76, 0x42, 0x2e, 0xfc, 0x3d, 0x2a }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIMarkupDocumentViewer : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMinFontSize(PRInt32 *aMinFontSize) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetMinFontSize(PRInt32 aMinFontSize) = 0;
...
#define NS_DECL_NSIMARKUPDOCUMENTVIEWER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMinFontSize(PRInt32 *aMinFontSize); \
  NS_SCRIPTABLE NS_IMETHOD SetMinFontSize(PRInt32 aMinFontSize); 
...
#define NS_FORWARD_NSIMARKUPDOCUMENTVIEWER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMinFontSize(PRInt32 *aMinFontSize) { return _to GetMinFontSize(aMinFontSize); } \
  NS_SCRIPTABLE NS_IMETHOD SetMinFontSize(PRInt32 aMinFontSize) { return _to SetMinFontSize(aMinFontSize); } 
...
#define NS_FORWARD_SAFE_NSIMARKUPDOCUMENTVIEWER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMinFontSize(PRInt32 *aMinFontSize) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMinFontSize(aMinFontSize); } \
  NS_SCRIPTABLE NS_IMETHOD SetMinFontSize(PRInt32 aMinFontSize) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMinFontSize(aMinFontSize); } 
...
/* attribute long minFontSize; */
NS_IMETHODIMP nsMarkupDocumentViewer::GetMinFontSize(PRInt32 *aMinFontSize)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsMarkupDocumentViewer::SetMinFontSize(PRInt32 aMinFontSize)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
