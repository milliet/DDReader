/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/editor/composer/public/nsIEditingSession.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIEditingSession : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetJsAndPluginsDisabled(PRBool *aJsAndPluginsDisabled) = 0;
...
#define NS_DECL_NSIEDITINGSESSION \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetJsAndPluginsDisabled(PRBool *aJsAndPluginsDisabled); 
...
#define NS_FORWARD_NSIEDITINGSESSION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetJsAndPluginsDisabled(PRBool *aJsAndPluginsDisabled) { return _to GetJsAndPluginsDisabled(aJsAndPluginsDisabled); } 
...
#define NS_FORWARD_SAFE_NSIEDITINGSESSION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetJsAndPluginsDisabled(PRBool *aJsAndPluginsDisabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetJsAndPluginsDisabled(aJsAndPluginsDisabled); } 
...
/* readonly attribute boolean jsAndPluginsDisabled; */
NS_IMETHODIMP nsEditingSession::GetJsAndPluginsDisabled(PRBool *aJsAndPluginsDisabled)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
