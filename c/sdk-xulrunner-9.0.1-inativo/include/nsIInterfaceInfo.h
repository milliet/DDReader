/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/xpcom/reflect/xptinfo/public/nsIInterfaceInfo.idl
 */
...
#define NS_IINTERFACEINFO_IID_STR "7de126a2-ef4b-4e3b-a952-78ce4c133e38"

#define NS_IINTERFACEINFO_IID \
  {0x7de126a2, 0xef4b, 0x4e3b, \
    { 0xa9, 0x52, 0x78, 0xce, 0x4c, 0x13, 0x3e, 0x38 }}
...
class NS_NO_VTABLE nsIInterfaceInfo : public nsISupports {
 public: 
  ...
  NS_IMETHOD IsBuiltinClass(PRBool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIINTERFACEINFO \
  ...
  NS_IMETHOD IsBuiltinClass(PRBool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIINTERFACEINFO(_to) \
  ...
  NS_IMETHOD IsBuiltinClass(PRBool *_retval NS_OUTPARAM) { return _to IsBuiltinClass(_retval); } \
...
#define NS_FORWARD_SAFE_NSIINTERFACEINFO(_to) \
  ...
  NS_IMETHOD IsBuiltinClass(PRBool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsBuiltinClass(_retval); } \
...
/* boolean isBuiltinClass (); */
NS_IMETHODIMP nsInterfaceInfo::IsBuiltinClass(PRBool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
