/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/js/src/xpconnect/idl/nsIXPConnect.idl
 */
...
class nsIXPConnect : public nsISupports {
 public: 
  ...
  NS_IMETHOD WrapNativeToJSVal(JSContext *aJSContext, JSObject *aScope, nsISupports *aCOMObj, nsWrapperCache *aCache, const nsIID *aIID, PRBool aAllowWrapper, JS::Value *aVal NS_OUTPARAM, nsIXPConnectJSObjectHolder * *aHolder NS_OUTPARAM) = 0;
  ...
  NS_IMETHOD EvalInSandboxObject(const nsAString & source, JSContext *cx, nsIXPConnectJSObjectHolder *sandbox, PRBool returnStringOnly, JS::Value *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIXPCONNECT \
  ...
  NS_IMETHOD WrapNativeToJSVal(JSContext *aJSContext, JSObject *aScope, nsISupports *aCOMObj, nsWrapperCache *aCache, const nsIID *aIID, PRBool aAllowWrapper, JS::Value *aVal NS_OUTPARAM, nsIXPConnectJSObjectHolder * *aHolder NS_OUTPARAM); \
  ...
  NS_IMETHOD EvalInSandboxObject(const nsAString & source, JSContext *cx, nsIXPConnectJSObjectHolder *sandbox, PRBool returnStringOnly, JS::Value *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIXPCONNECT(_to) \
  ...
  NS_IMETHOD EvalInSandboxObject(const nsAString & source, JSContext *cx, nsIXPConnectJSObjectHolder *sandbox, PRBool returnStringOnly, JS::Value *_retval NS_OUTPARAM) { return _to EvalInSandboxObject(source, cx, sandbox, returnStringOnly, _retval); } \
...
#define NS_FORWARD_SAFE_NSIXPCONNECT(_to) \
  ...
  NS_IMETHOD EvalInSandboxObject(const nsAString & source, JSContext *cx, nsIXPConnectJSObjectHolder *sandbox, PRBool returnStringOnly, JS::Value *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->EvalInSandboxObject(source, cx, sandbox, returnStringOnly, _retval); } \
...
/* void wrapNativeToJSVal (in JSContextPtr aJSContext, in JSObjectPtr aScope, in nsISupports aCOMObj, in nsWrapperCachePtr aCache, in nsIIDPtr aIID, in boolean aAllowWrapper, out jsval aVal, out nsIXPConnectJSObjectHolder aHolder); */
NS_IMETHODIMP nsXPConnect::WrapNativeToJSVal(JSContext *aJSContext, JSObject *aScope, nsISupports *aCOMObj, nsWrapperCache *aCache, const nsIID *aIID, PRBool aAllowWrapper, JS::Value *aVal NS_OUTPARAM, nsIXPConnectJSObjectHolder * *aHolder NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* [noscript] jsval evalInSandboxObject (in AString source, in JSContextPtr cx, in nsIXPConnectJSObjectHolder sandbox, in boolean returnStringOnly); */
NS_IMETHODIMP nsXPConnect::EvalInSandboxObject(const nsAString & source, JSContext *cx, nsIXPConnectJSObjectHolder *sandbox, PRBool returnStringOnly, JS::Value *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE nsIXPConnect_MOZILLA_10_BRANCH : public nsISupports {
 public: 
  ...
  NS_IMETHOD SetDebugModeWhenPossible(PRBool mode, PRBool allowSyncDisable) = 0;
...
#define NS_DECL_NSIXPCONNECT_MOZILLA_10_BRANCH \
  NS_IMETHOD SetDebugModeWhenPossible(PRBool mode, PRBool allowSyncDisable); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIXPCONNECT_MOZILLA_10_BRANCH(_to) \
  NS_IMETHOD SetDebugModeWhenPossible(PRBool mode, PRBool allowSyncDisable) { return _to SetDebugModeWhenPossible(mode, allowSyncDisable); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIXPCONNECT_MOZILLA_10_BRANCH(_to) \
  NS_IMETHOD SetDebugModeWhenPossible(PRBool mode, PRBool allowSyncDisable) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetDebugModeWhenPossible(mode, allowSyncDisable); } 
...
/* [noscript] void setDebugModeWhenPossible (in boolean mode, in boolean allowSyncDisable); */
NS_IMETHODIMP nsXPConnect_MOZILLA_10_BRANCH::SetDebugModeWhenPossible(PRBool mode, PRBool allowSyncDisable)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
