/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/xpcom/io/nsIInputStreamTee.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIInputStreamTee : public nsIInputStream {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEventTarget(nsIEventTarget * *aEventTarget) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetEventTarget(nsIEventTarget *aEventTarget) = 0;
...
#define NS_DECL_NSIINPUTSTREAMTEE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEventTarget(nsIEventTarget * *aEventTarget); \
  NS_SCRIPTABLE NS_IMETHOD SetEventTarget(nsIEventTarget *aEventTarget); 
...
#define NS_FORWARD_NSIINPUTSTREAMTEE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEventTarget(nsIEventTarget * *aEventTarget) { return _to GetEventTarget(aEventTarget); } \
  NS_SCRIPTABLE NS_IMETHOD SetEventTarget(nsIEventTarget *aEventTarget) { return _to SetEventTarget(aEventTarget); } 
...
#define NS_FORWARD_SAFE_NSIINPUTSTREAMTEE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEventTarget(nsIEventTarget * *aEventTarget) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEventTarget(aEventTarget); } \
  NS_SCRIPTABLE NS_IMETHOD SetEventTarget(nsIEventTarget *aEventTarget) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetEventTarget(aEventTarget); } 
