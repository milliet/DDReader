/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/netwerk/base/public/nsINetworkLinkService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsINetworkLinkService : public nsISupports {
 public: 
  ...
  enum { LINK_TYPE_UNKNOWN = 0U };

  enum { LINK_TYPE_ETHERNET = 1U };

  enum { LINK_TYPE_USB = 2U };

  enum { LINK_TYPE_WIFI = 3U };

  enum { LINK_TYPE_WIMAX = 4U };

  enum { LINK_TYPE_2G = 5U };

  enum { LINK_TYPE_3G = 6U };

  enum { LINK_TYPE_4G = 7U };
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLinkType(PRUint32 *aLinkType) = 0;
...
#define NS_DECL_NSINETWORKLINKSERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLinkType(PRUint32 *aLinkType); 
...
#define NS_FORWARD_NSINETWORKLINKSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLinkType(PRUint32 *aLinkType) { return _to GetLinkType(aLinkType); } 
...
#define NS_FORWARD_SAFE_NSINETWORKLINKSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLinkType(PRUint32 *aLinkType) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLinkType(aLinkType); } 
...
/* readonly attribute unsigned long linkType; */
NS_IMETHODIMP nsNetworkLinkService::GetLinkType(PRUint32 *aLinkType)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
