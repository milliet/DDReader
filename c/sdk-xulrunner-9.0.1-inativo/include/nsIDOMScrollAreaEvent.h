/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/interfaces/events/nsIDOMScrollAreaEvent.idl
 */
...
#define NS_IDOMSCROLLAREAEVENT_IID_STR "00028177-32a5-4ea3-b71d-8409beb15225"

#define NS_IDOMSCROLLAREAEVENT_IID \
  {0x00028177, 0x32a5, 0x4ea3, \
    { 0xb7, 0x1d, 0x84, 0x09, 0xbe, 0xb1, 0x52, 0x25 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMScrollAreaEvent : public nsIDOMUIEvent {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD InitScrollAreaEvent(const nsAString & aEventType, PRBool aCanBubble, PRBool aCancelable, nsIDOMWindow *aView, PRInt32 aDetail, float x, float y, float width, float height) = 0;
...
#define NS_DECL_NSIDOMSCROLLAREAEVENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD InitScrollAreaEvent(const nsAString & aEventType, PRBool aCanBubble, PRBool aCancelable, nsIDOMWindow *aView, PRInt32 aDetail, float x, float y, float width, float height); 
...
#define NS_FORWARD_NSIDOMSCROLLAREAEVENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD InitScrollAreaEvent(const nsAString & aEventType, PRBool aCanBubble, PRBool aCancelable, nsIDOMWindow *aView, PRInt32 aDetail, float x, float y, float width, float height) { return _to InitScrollAreaEvent(aEventType, aCanBubble, aCancelable, aView, aDetail, x, y, width, height); } 
...
#define NS_FORWARD_SAFE_NSIDOMSCROLLAREAEVENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD InitScrollAreaEvent(const nsAString & aEventType, PRBool aCanBubble, PRBool aCancelable, nsIDOMWindow *aView, PRInt32 aDetail, float x, float y, float width, float height) { return !_to ? NS_ERROR_NULL_POINTER : _to->InitScrollAreaEvent(aEventType, aCanBubble, aCancelable, aView, aDetail, x, y, width, height); } 
...
/* void initScrollAreaEvent (in DOMString aEventType, in boolean aCanBubble, in boolean aCancelable, in nsIDOMWindow aView, in long aDetail, in float x, in float y, in float width, in float height); */
NS_IMETHODIMP nsDOMScrollAreaEvent::InitScrollAreaEvent(const nsAString & aEventType, PRBool aCanBubble, PRBool aCancelable, nsIDOMWindow *aView, PRInt32 aDetail, float x, float y, float width, float height)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
