/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/accessible/public/nsIAccessibleApplication.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAccessibleApplication : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPlatformName(nsAString & aPlatformName) = 0;
...
#define NS_DECL_NSIACCESSIBLEAPPLICATION \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPlatformName(nsAString & aPlatformName); \
...
#define NS_FORWARD_NSIACCESSIBLEAPPLICATION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPlatformName(nsAString & aPlatformName) { return _to GetPlatformName(aPlatformName); } \
...
#define NS_FORWARD_SAFE_NSIACCESSIBLEAPPLICATION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPlatformName(nsAString & aPlatformName) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPlatformName(aPlatformName); } \
