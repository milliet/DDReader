/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/docshell/base/nsIClipboardCommands.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIClipboardCommands : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD CanCutSelection(PRBool *_retval NS_OUTPARAM) = 0;

  /* boolean canCopySelection (); */
  NS_SCRIPTABLE NS_IMETHOD CanCopySelection(PRBool *_retval NS_OUTPARAM) = 0;

  /* boolean canCopyLinkLocation (); */
  NS_SCRIPTABLE NS_IMETHOD CanCopyLinkLocation(PRBool *_retval NS_OUTPARAM) = 0;

  /* boolean canCopyImageLocation (); */
  NS_SCRIPTABLE NS_IMETHOD CanCopyImageLocation(PRBool *_retval NS_OUTPARAM) = 0;

  /* boolean canCopyImageContents (); */
  NS_SCRIPTABLE NS_IMETHOD CanCopyImageContents(PRBool *_retval NS_OUTPARAM) = 0;

  /* boolean canPaste (); */
  NS_SCRIPTABLE NS_IMETHOD CanPaste(PRBool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSICLIPBOARDCOMMANDS \
  NS_SCRIPTABLE NS_IMETHOD CanCutSelection(PRBool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD CanCopySelection(PRBool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD CanCopyLinkLocation(PRBool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD CanCopyImageLocation(PRBool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD CanCopyImageContents(PRBool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD CanPaste(PRBool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSICLIPBOARDCOMMANDS(_to) \
  NS_SCRIPTABLE NS_IMETHOD CanCutSelection(PRBool *_retval NS_OUTPARAM) { return _to CanCutSelection(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CanCopySelection(PRBool *_retval NS_OUTPARAM) { return _to CanCopySelection(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CanCopyLinkLocation(PRBool *_retval NS_OUTPARAM) { return _to CanCopyLinkLocation(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CanCopyImageLocation(PRBool *_retval NS_OUTPARAM) { return _to CanCopyImageLocation(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CanCopyImageContents(PRBool *_retval NS_OUTPARAM) { return _to CanCopyImageContents(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CanPaste(PRBool *_retval NS_OUTPARAM) { return _to CanPaste(_retval); } \
...
#define NS_FORWARD_SAFE_NSICLIPBOARDCOMMANDS(_to) \
  NS_SCRIPTABLE NS_IMETHOD CanCutSelection(PRBool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CanCutSelection(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CanCopySelection(PRBool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CanCopySelection(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CanCopyLinkLocation(PRBool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CanCopyLinkLocation(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CanCopyImageLocation(PRBool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CanCopyImageLocation(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CanCopyImageContents(PRBool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CanCopyImageContents(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD CanPaste(PRBool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CanPaste(_retval); } \
...
/* boolean canCutSelection (); */
NS_IMETHODIMP nsClipboardCommands::CanCutSelection(PRBool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean canCopySelection (); */
NS_IMETHODIMP nsClipboardCommands::CanCopySelection(PRBool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean canCopyLinkLocation (); */
NS_IMETHODIMP nsClipboardCommands::CanCopyLinkLocation(PRBool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean canCopyImageLocation (); */
NS_IMETHODIMP nsClipboardCommands::CanCopyImageLocation(PRBool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean canCopyImageContents (); */
NS_IMETHODIMP nsClipboardCommands::CanCopyImageContents(PRBool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean canPaste (); */
NS_IMETHODIMP nsClipboardCommands::CanPaste(PRBool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
