/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/modules/libpr0n/public/imgIEncoder.idl
 */
...
#define IMGIENCODER_IID_STR "d02e2d95-072d-4b91-8b8f-1300e45fcb2b"

#define IMGIENCODER_IID \
  {0xd02e2d95, 0x072d, 0x4b91, \
    { 0x8b, 0x8f, 0x13, 0x00, 0xe4, 0x5f, 0xcb, 0x2b }}
...
class NS_NO_VTABLE NS_SCRIPTABLE imgIEncoder : public nsIAsyncInputStream {
 public: 
  ...
  NS_IMETHOD GetImageBufferSize(PRUint32 *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_IMGIENCODER \
  ...
  NS_IMETHOD GetImageBufferSize(PRUint32 *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_IMGIENCODER(_to) \
  ...
  NS_IMETHOD GetImageBufferSize(PRUint32 *_retval NS_OUTPARAM) { return _to GetImageBufferSize(_retval); } \
...
#define NS_FORWARD_SAFE_IMGIENCODER(_to) \
  ...
  NS_IMETHOD GetImageBufferSize(PRUint32 *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetImageBufferSize(_retval); } \
...
/* [noscript] unsigned long getImageBufferSize (); */
NS_IMETHODIMP _MYCLASS_::GetImageBufferSize(PRUint32 *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
