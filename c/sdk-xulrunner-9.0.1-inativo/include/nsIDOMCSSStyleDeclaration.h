/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/interfaces/css/nsIDOMCSSStyleDeclaration.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMCSSStyleDeclaration : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPropertyValue(const nsAString & propertyName, nsAString & _retval NS_OUTPARAM) = 0;

  /* nsIDOMCSSValue getPropertyCSSValue (in DOMString propertyName); */
  NS_SCRIPTABLE NS_IMETHOD GetPropertyCSSValue(const nsAString & propertyName, nsIDOMCSSValue * *_retval NS_OUTPARAM) = 0;

  /* DOMString removeProperty (in DOMString propertyName) raises (DOMException); */
  NS_SCRIPTABLE NS_IMETHOD RemoveProperty(const nsAString & propertyName, nsAString & _retval NS_OUTPARAM) = 0;

  /* DOMString getPropertyPriority (in DOMString propertyName); */
  NS_SCRIPTABLE NS_IMETHOD GetPropertyPriority(const nsAString & propertyName, nsAString & _retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOMCSSSTYLEDECLARATION \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPropertyValue(const nsAString & propertyName, nsAString & _retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD GetPropertyCSSValue(const nsAString & propertyName, nsIDOMCSSValue * *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD RemoveProperty(const nsAString & propertyName, nsAString & _retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD GetPropertyPriority(const nsAString & propertyName, nsAString & _retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIDOMCSSSTYLEDECLARATION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPropertyValue(const nsAString & propertyName, nsAString & _retval NS_OUTPARAM) { return _to GetPropertyValue(propertyName, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetPropertyCSSValue(const nsAString & propertyName, nsIDOMCSSValue * *_retval NS_OUTPARAM) { return _to GetPropertyCSSValue(propertyName, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD RemoveProperty(const nsAString & propertyName, nsAString & _retval NS_OUTPARAM) { return _to RemoveProperty(propertyName, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetPropertyPriority(const nsAString & propertyName, nsAString & _retval NS_OUTPARAM) { return _to GetPropertyPriority(propertyName, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMCSSSTYLEDECLARATION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetPropertyValue(const nsAString & propertyName, nsAString & _retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPropertyValue(propertyName, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetPropertyCSSValue(const nsAString & propertyName, nsIDOMCSSValue * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPropertyCSSValue(propertyName, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD RemoveProperty(const nsAString & propertyName, nsAString & _retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveProperty(propertyName, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetPropertyPriority(const nsAString & propertyName, nsAString & _retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPropertyPriority(propertyName, _retval); } \
...
/* DOMString getPropertyValue (in DOMString propertyName); */
NS_IMETHODIMP nsDOMCSSStyleDeclaration::GetPropertyValue(const nsAString & propertyName, nsAString & _retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIDOMCSSValue getPropertyCSSValue (in DOMString propertyName); */
NS_IMETHODIMP nsDOMCSSStyleDeclaration::GetPropertyCSSValue(const nsAString & propertyName, nsIDOMCSSValue * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* DOMString removeProperty (in DOMString propertyName) raises (DOMException); */
NS_IMETHODIMP nsDOMCSSStyleDeclaration::RemoveProperty(const nsAString & propertyName, nsAString & _retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* DOMString getPropertyPriority (in DOMString propertyName); */
NS_IMETHODIMP nsDOMCSSStyleDeclaration::GetPropertyPriority(const nsAString & propertyName, nsAString & _retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* DOMString item (in unsigned long index); */
NS_IMETHODIMP nsDOMCSSStyleDeclaration::Item(PRUint32 index, nsAString & _retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
