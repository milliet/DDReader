/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/netwerk/base/public/nsITimedChannel.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITimedChannel : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTimingEnabled(PRBool *aTimingEnabled) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetTimingEnabled(PRBool aTimingEnabled) = 0;
...
#define NS_DECL_NSITIMEDCHANNEL \
  NS_SCRIPTABLE NS_IMETHOD GetTimingEnabled(PRBool *aTimingEnabled); \
  NS_SCRIPTABLE NS_IMETHOD SetTimingEnabled(PRBool aTimingEnabled); \
...
#define NS_FORWARD_NSITIMEDCHANNEL(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetTimingEnabled(PRBool *aTimingEnabled) { return _to GetTimingEnabled(aTimingEnabled); } \
  NS_SCRIPTABLE NS_IMETHOD SetTimingEnabled(PRBool aTimingEnabled) { return _to SetTimingEnabled(aTimingEnabled); } \
...
#define NS_FORWARD_SAFE_NSITIMEDCHANNEL(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetTimingEnabled(PRBool *aTimingEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTimingEnabled(aTimingEnabled); } \
  NS_SCRIPTABLE NS_IMETHOD SetTimingEnabled(PRBool aTimingEnabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetTimingEnabled(aTimingEnabled); } \
...
/* attribute boolean timingEnabled; */
NS_IMETHODIMP nsTimedChannel::GetTimingEnabled(PRBool *aTimingEnabled)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsTimedChannel::SetTimingEnabled(PRBool aTimingEnabled)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
