/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/netwerk/base/public/nsIAsyncVerifyRedirectCallback.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAsyncVerifyRedirectCallback : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IASYNCVERIFYREDIRECTCALLBACK_IID)

  /* void onRedirectVerifyCallback (in nsresult result); */
  NS_SCRIPTABLE NS_IMETHOD OnRedirectVerifyCallback(nsresult result) = 0;
...
#define NS_DECL_NSIASYNCVERIFYREDIRECTCALLBACK \
  NS_SCRIPTABLE NS_IMETHOD OnRedirectVerifyCallback(nsresult result); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIASYNCVERIFYREDIRECTCALLBACK(_to) \
  NS_SCRIPTABLE NS_IMETHOD OnRedirectVerifyCallback(nsresult result) { return _to OnRedirectVerifyCallback(result); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIASYNCVERIFYREDIRECTCALLBACK(_to) \
  NS_SCRIPTABLE NS_IMETHOD OnRedirectVerifyCallback(nsresult result) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnRedirectVerifyCallback(result); } 
