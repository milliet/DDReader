/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/js/src/xpconnect/idl/nsIJSEngineTelemetryStats.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIJSEngineTelemetryStats : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IJSENGINETELEMETRYSTATS_IID)

  /* [implicit_jscontext] readonly attribute jsval telemetryValue; */
  NS_SCRIPTABLE NS_IMETHOD GetTelemetryValue(JSContext* cx, JS::Value *aTelemetryValue) = 0;
...
#define NS_DECL_NSIJSENGINETELEMETRYSTATS \
  NS_SCRIPTABLE NS_IMETHOD GetTelemetryValue(JSContext* cx, JS::Value *aTelemetryValue); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIJSENGINETELEMETRYSTATS(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetTelemetryValue(JSContext* cx, JS::Value *aTelemetryValue) { return _to GetTelemetryValue(cx, aTelemetryValue); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIJSENGINETELEMETRYSTATS(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetTelemetryValue(JSContext* cx, JS::Value *aTelemetryValue) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTelemetryValue(cx, aTelemetryValue); } 
