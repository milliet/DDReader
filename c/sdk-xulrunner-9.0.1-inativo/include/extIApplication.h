/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/toolkit/components/exthelper/extIApplication.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE extIExtensionsCallback : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(EXTIEXTENSIONSCALLBACK_IID)

  /* void callback (in nsIVariant extensions); */
  NS_SCRIPTABLE NS_IMETHOD Callback(nsIVariant *extensions) = 0;
...
#define NS_DECL_EXTIEXTENSIONSCALLBACK \
  NS_SCRIPTABLE NS_IMETHOD Callback(nsIVariant *extensions); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_EXTIEXTENSIONSCALLBACK(_to) \
  NS_SCRIPTABLE NS_IMETHOD Callback(nsIVariant *extensions) { return _to Callback(extensions); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_EXTIEXTENSIONSCALLBACK(_to) \
  NS_SCRIPTABLE NS_IMETHOD Callback(nsIVariant *extensions) { return !_to ? NS_ERROR_NULL_POINTER : _to->Callback(extensions); } 
