/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/interfaces/base/nsIDOMMediaQueryList.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMMediaQueryList : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMatches(PRBool *aMatches) = 0;

  /* void addListener (in nsIDOMMediaQueryListListener listener); */
  NS_SCRIPTABLE NS_IMETHOD AddListener(nsIDOMMediaQueryListListener *listener) = 0;

  /* void removeListener (in nsIDOMMediaQueryListListener listener); */
  NS_SCRIPTABLE NS_IMETHOD RemoveListener(nsIDOMMediaQueryListListener *listener) = 0;
...
#define NS_DECL_NSIDOMMEDIAQUERYLIST \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMatches(PRBool *aMatches); \
  NS_SCRIPTABLE NS_IMETHOD AddListener(nsIDOMMediaQueryListListener *listener); \
  NS_SCRIPTABLE NS_IMETHOD RemoveListener(nsIDOMMediaQueryListListener *listener); 
...
#define NS_FORWARD_NSIDOMMEDIAQUERYLIST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMatches(PRBool *aMatches) { return _to GetMatches(aMatches); } \
  NS_SCRIPTABLE NS_IMETHOD AddListener(nsIDOMMediaQueryListListener *listener) { return _to AddListener(listener); } \
  NS_SCRIPTABLE NS_IMETHOD RemoveListener(nsIDOMMediaQueryListListener *listener) { return _to RemoveListener(listener); } 
...
#define NS_FORWARD_SAFE_NSIDOMMEDIAQUERYLIST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMatches(PRBool *aMatches) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMatches(aMatches); } \
  NS_SCRIPTABLE NS_IMETHOD AddListener(nsIDOMMediaQueryListListener *listener) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddListener(listener); } \
  NS_SCRIPTABLE NS_IMETHOD RemoveListener(nsIDOMMediaQueryListListener *listener) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveListener(listener); } 
...
/* readonly attribute boolean matches; */
NS_IMETHODIMP nsDOMMediaQueryList::GetMatches(PRBool *aMatches)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMMediaQueryListListener : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOMMEDIAQUERYLISTLISTENER_IID)

  /* void handleChange (in nsIDOMMediaQueryList mql); */
  NS_SCRIPTABLE NS_IMETHOD HandleChange(nsIDOMMediaQueryList *mql) = 0;
...
#define NS_DECL_NSIDOMMEDIAQUERYLISTLISTENER \
  NS_SCRIPTABLE NS_IMETHOD HandleChange(nsIDOMMediaQueryList *mql); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMMEDIAQUERYLISTLISTENER(_to) \
  NS_SCRIPTABLE NS_IMETHOD HandleChange(nsIDOMMediaQueryList *mql) { return _to HandleChange(mql); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMMEDIAQUERYLISTLISTENER(_to) \
  NS_SCRIPTABLE NS_IMETHOD HandleChange(nsIDOMMediaQueryList *mql) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleChange(mql); } 
