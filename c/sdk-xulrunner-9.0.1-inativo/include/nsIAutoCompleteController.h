/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/toolkit/components/autocomplete/nsIAutoCompleteController.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAutoCompleteController : public nsISupports {
 public: 
  ...
  /* void handleText (); */
  NS_SCRIPTABLE NS_IMETHOD HandleText(void) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLabelAt(PRInt32 index, nsAString & _retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIAUTOCOMPLETECONTROLLER \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleText(void); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLabelAt(PRInt32 index, nsAString & _retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIAUTOCOMPLETECONTROLLER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleText(void) { return _to HandleText(); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLabelAt(PRInt32 index, nsAString & _retval NS_OUTPARAM) { return _to GetLabelAt(index, _retval); } \
...
#define NS_FORWARD_SAFE_NSIAUTOCOMPLETECONTROLLER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HandleText(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleText(); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLabelAt(PRInt32 index, nsAString & _retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLabelAt(index, _retval); } \
...
/* AString getLabelAt (in long index); */
NS_IMETHODIMP nsAutoCompleteController::GetLabelAt(PRInt32 index, nsAString & _retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
