/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/netwerk/base/public/nsITraceableChannel.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITraceableChannel : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SetNewListener(nsIStreamListener *aListener, nsIStreamListener * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSITRACEABLECHANNEL \
  NS_SCRIPTABLE NS_IMETHOD SetNewListener(nsIStreamListener *aListener, nsIStreamListener * *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSITRACEABLECHANNEL(_to) \
  NS_SCRIPTABLE NS_IMETHOD SetNewListener(nsIStreamListener *aListener, nsIStreamListener * *_retval NS_OUTPARAM) { return _to SetNewListener(aListener, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSITRACEABLECHANNEL(_to) \
  NS_SCRIPTABLE NS_IMETHOD SetNewListener(nsIStreamListener *aListener, nsIStreamListener * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetNewListener(aListener, _retval); } 
...
/* nsIStreamListener setNewListener (in nsIStreamListener aListener); */
NS_IMETHODIMP nsTraceableChannel::SetNewListener(nsIStreamListener *aListener, nsIStreamListener * *_retval NS_OUTPARAM)
{
