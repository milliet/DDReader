...
#define NS_ISELECTION_IID_STR "5ac0cd5d-3c08-4c4c-8e70-230c433f5d5c"

#define NS_ISELECTION_IID \
  {0x5ac0cd5d, 0x3c08, 0x4c4c, \
    { 0x8e, 0x70, 0x23, 0x0c, 0x43, 0x3f, 0x5d, 0x5c }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISelection : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ContainsNode(nsIDOMNode *node, PRBool partlyContained, PRBool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSISELECTION \
  ...
  NS_SCRIPTABLE NS_IMETHOD ContainsNode(nsIDOMNode *node, PRBool partlyContained, PRBool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSISELECTION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ContainsNode(nsIDOMNode *node, PRBool partlyContained, PRBool *_retval NS_OUTPARAM) { return _to ContainsNode(node, partlyContained, _retval); } \
...
#define NS_FORWARD_SAFE_NSISELECTION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ContainsNode(nsIDOMNode *node, PRBool partlyContained, PRBool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ContainsNode(node, partlyContained, _retval); } \
...
/* boolean containsNode (in nsIDOMNode node, in boolean partlyContained); */
NS_IMETHODIMP nsSelection::ContainsNode(nsIDOMNode *node, PRBool partlyContained, PRBool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
