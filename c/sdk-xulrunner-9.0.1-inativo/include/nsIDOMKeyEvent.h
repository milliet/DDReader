...
#define NS_IDOMKEYEVENT_IID_STR "ffcfb88a-d1d1-40b9-96e1-e338211d3511"

#define NS_IDOMKEYEVENT_IID \
  {0xffcfb88a, 0xd1d1, 0x40b9, \
    { 0x96, 0xe1, 0xe3, 0x38, 0x21, 0x1d, 0x35, 0x11 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMKeyEvent : public nsIDOMUIEvent {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD InitKeyEvent(const nsAString & typeArg, PRBool canBubbleArg, PRBool cancelableArg, nsIDOMWindow *viewArg, PRBool ctrlKeyArg, PRBool altKeyArg, PRBool shiftKeyArg, PRBool metaKeyArg, PRUint32 keyCodeArg, PRUint32 charCodeArg) = 0;
...
#define NS_DECL_NSIDOMKEYEVENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD InitKeyEvent(const nsAString & typeArg, PRBool canBubbleArg, PRBool cancelableArg, nsIDOMWindow *viewArg, PRBool ctrlKeyArg, PRBool altKeyArg, PRBool shiftKeyArg, PRBool metaKeyArg, PRUint32 keyCodeArg, PRUint32 charCodeArg); 
...
/* void initKeyEvent (in DOMString typeArg, in boolean canBubbleArg, in boolean cancelableArg, in nsIDOMWindow viewArg, in boolean ctrlKeyArg, in boolean altKeyArg, in boolean shiftKeyArg, in boolean metaKeyArg, in unsigned long keyCodeArg, in unsigned long charCodeArg); */
NS_IMETHODIMP nsDOMKeyEvent::InitKeyEvent(const nsAString & typeArg, PRBool canBubbleArg, PRBool cancelableArg, nsIDOMWindow *viewArg, PRBool ctrlKeyArg, PRBool altKeyArg, PRBool shiftKeyArg, PRBool metaKeyArg, PRUint32 keyCodeArg, PRUint32 charCodeArg)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
