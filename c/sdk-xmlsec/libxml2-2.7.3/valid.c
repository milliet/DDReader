...
xmlVErrMemory(xmlValidCtxtPtr ctxt, const char *extra)
{
	...
	if ((ctxt->finishDtd == XML_CTXT_FINISH_DTD_0) ||
		...
		pctxt = (struct _xmlParserCtxt *)ctxt->userData;
	}
    }
    if (extra)
...
xmlAddElementDecl(xmlValidCtxtPtr ctxt,
	...
	ret = (struct _xmlElement *)xmlHashLookup2((struct _xmlHashTable *)dtd->doc->intSubset->elements, name, ns);
	if ((ret != NULL) && (ret->etype == XML_ELEMENT_TYPE_UNDEFINED)) {
	    oldAttributes = ret->attributes;
	    ret->attributes = NULL;
	    xmlHashRemoveEntry2((struct _xmlHashTable *)dtd->doc->intSubset->elements, name, ns, NULL);
	    xmlFreeElement(ret);
	}
    }
     ...
     */
    ret = (struct _xmlElement *)xmlHashLookup2(table, name, ns);
    if (ret != NULL) {
...
xmlAddAttributeDecl(xmlValidCtxtPtr ctxt,
	...
	(dtd->doc->intSubset->attributes != NULL)) {
        ret = (struct _xmlAttribute *)xmlHashLookup3((struct _xmlHashTable *)dtd->doc->intSubset->attributes, name, ns, elem);
	if (ret != NULL) {
	    xmlFreeEnumeration(tree);
	    return(NULL);
	}
...
xmlRemoveID(xmlDocPtr doc, xmlAttrPtr attr) {
    ...
    if (ID == NULL)
	return(-1);
    id = (struct _xmlID *)xmlHashLookup(table, ID);
...
xmlAddRef(xmlValidCtxtPtr ctxt, xmlDocPtr doc, const xmlChar *value,
    ...
    if (NULL == (ref_list = (struct _xmlList *)xmlHashLookup(table, value))) {
...
xmlRemoveRef(xmlDocPtr doc, xmlAttrPtr attr) {
    ...
    if (ID == NULL)
        return(-1);
    ref_list = (struct _xmlList *)xmlHashLookup(table, ID);
...
xmlGetRefs(xmlDocPtr doc, const xmlChar *ID) {
    ...
    return (struct _xmlList *)(xmlHashLookup(table, ID));
}
...
xmlGetDtdElementDesc(xmlDtdPtr dtd, const xmlChar *name) {
    ...
    if (uqname != NULL)
        name = uqname;
    cur = (struct _xmlElement *)xmlHashLookup2(table, name, prefix);
...
xmlGetDtdQElementDesc(xmlDtdPtr dtd, const xmlChar *name,
    ...
    return (struct _xmlElement *)(xmlHashLookup2(table, name, prefix));
}
...
xmlGetDtdAttrDesc(xmlDtdPtr dtd, const xmlChar *elem, const xmlChar *name) {
    ...
    if (uqname != NULL) {
	cur = (struct _xmlAttribute *)xmlHashLookup3(table, uqname, prefix, elem);
	if (prefix != NULL) xmlFree(prefix);
	if (uqname != NULL) xmlFree(uqname);
    } else
	cur = (struct _xmlAttribute *)xmlHashLookup3(table, name, NULL, elem);
    return(cur);
}
...
xmlGetDtdQAttrDesc(xmlDtdPtr dtd, const xmlChar *elem, const xmlChar *name,
    ...
    return (struct _xmlAttribute *)(xmlHashLookup3(table, name, prefix, elem));
}
...
xmlGetDtdNotationDesc(xmlDtdPtr dtd, const xmlChar *name) {
    ...
    return (struct _xmlNotation *)(xmlHashLookup(table, name));
}
